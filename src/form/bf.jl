...
"""
function constraint_branch_current(pm::AbstractBFQPModel, n::Int, c::Int, i, f_bus, f_idx, g_sh_fr, b_sh_fr, tm)
    p_fr   = var(pm, n, c, :p, f_idx)
    q_fr   = var(pm, n, c, :q, f_idx)
    w_fr   = var(pm, n, c, :w, f_bus)
    cm = var(pm, n, c, :cm, i)
...
Defines relationship between branch (series) power flow, branch (series) current and node voltage magnitude
"""
function constraint_branch_current(pm::AbstractBFConicModel, n::Int, c::Int, i, f_bus, f_idx, g_sh_fr, b_sh_fr, tm)
    p_fr   = var(pm, n, c, :p, f_idx)
    q_fr   = var(pm, n, c, :q, f_idx)
    w_fr   = var(pm, n, c, :w, f_bus)
    cm = var(pm, n, c, :cm, i)
