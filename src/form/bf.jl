...
number={},
pages={3672-3679},
keywords={convex programming;load flow control;network topology;phase shifters;power electronics;trees (mathematics);voltage control;branch flow model;mesh analysis;mesh optimization;radial network;optimal power flow problem;OPF problem;relaxation step;conic program;angle relaxation;mesh network convexification;phase shifter;spanning tree;network graph;network topology;operating constraint;power network;Mathematical model;Integrated circuit modeling;Phase shifters;Equations;Mesh networks;Load modeling;Optimization},
