...
function variable_gen_power_imaginary(pm::AbstractActivePowerModel; nw::Int=pm.cnw, report::Bool=true, kwargs...)
    report && _IM.sol_component_fixed(pm, :ep, nw, :gen, :qg, ids(pm, nw, :gen), NaN)
end
...
function variable_storage_power_imaginary(pm::AbstractActivePowerModel; nw::Int=pm.cnw, report::Bool=true, kwargs...)
    report && _IM.sol_component_fixed(pm, :ep, nw, :storage, :qs, ids(pm, nw, :storage), NaN)
end
...
function variable_branch_power_imaginary(pm::AbstractActivePowerModel; nw::Int=pm.cnw, report::Bool=true, kwargs...)
    report && _IM.sol_component_fixed(pm, :ep, nw, :branch, :qf, ids(pm, nw, :branch), NaN)
    report && _IM.sol_component_fixed(pm, :ep, nw, :branch, :qt, ids(pm, nw, :branch), NaN)
end

"apo models ignore reactive power flows"
function variable_ne_branch_power_imaginary(pm::AbstractActivePowerModel; nw::Int=pm.cnw, report::Bool=true, kwargs...)
    report && _IM.sol_component_fixed(pm, :ep, nw, :ne_branch, :q_ne_fr, ids(pm, nw, :ne_branch), NaN)
    report && _IM.sol_component_fixed(pm, :ep, nw, :ne_branch, :q_ne_to, ids(pm, nw, :ne_branch), NaN)
end

"apo models ignore reactive power flows"
function variable_dcline_power_imaginary(pm::AbstractActivePowerModel; nw::Int=pm.cnw, report::Bool=true, kwargs...)
    report && _IM.sol_component_fixed(pm, :ep, nw, :dcline, :qf, ids(pm, nw, :dcline), NaN)
    report && _IM.sol_component_fixed(pm, :ep, nw, :dcline, :qt, ids(pm, nw, :dcline), NaN)
end
