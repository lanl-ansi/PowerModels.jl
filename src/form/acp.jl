...
function constraint_kcl_shunt_ne(pm::GenericPowerModel{T}, n::Int, h::Int, i, bus_arcs, bus_arcs_dc, bus_arcs_ne, bus_gens, bus_pd, bus_qd, bus_gs, bus_bs) where T <: AbstractACPForm
    vm   = var(pm, n, h, :vm, i)
    p    = var(pm, n, h, :p)
    q    = var(pm, n, h, :q)
