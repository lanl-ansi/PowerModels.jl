...
""
function constraint_voltage(pm::AbstractWRModel, n::Int, c::Int)
    w  = var(pm, n, c,  :w)
    wr = var(pm, n, c, :wr)
    wi = var(pm, n, c, :wi)
...
""
function constraint_voltage(pm::AbstractWRConicModel, n::Int, c::Int)
    w  = var(pm, n, c,  :w)
    wr = var(pm, n, c, :wr)
    wi = var(pm, n, c, :wi)
...
""
function constraint_voltage_on_off(pm::AbstractWRModel, n::Int, c::Int)
    w  = var(pm, n, c, :w)
    wr = var(pm, n, c, :wr)
    wi = var(pm, n, c, :wi)
...
""
function constraint_voltage_ne(pm::AbstractWRModel, n::Int, c::Int)
    buses = ref(pm, n, :bus)
...
""
function constraint_voltage(pm::AbstractQCWRModel, n::Int, c::Int)
    v = var(pm, n, c, :vm)
    t = var(pm, n, c, :va)
...
""
function add_bus_voltage_setpoint(sol, pm::AbstractQCWRModel)
...
""
function constraint_voltage_on_off(pm::AbstractQCWRModel, n::Int, c::Int)
    v = var(pm, n, c, :vm)
    t = var(pm, n, c, :va)
    vm_fr = var(pm, n, c, :vm_fr)
    vm_to = var(pm, n, c, :vm_to)
...
function variable_multipliers(pm::AbstractQCWRTriModel; nw::Int=pm.cnw, cnd::Int=pm.ccnd)
...
""
function constraint_voltage(pm::AbstractQCWRTriModel, n::Int, c::Int)
    v = var(pm, n, c, :vm)
    t = var(pm, n, c, :va)
