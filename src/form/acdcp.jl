export
    ACDCPPowerModel, StandardACPForm,
    APIACDCPPowerModel, APIACPForm
...
""
const ACDCPPowerModel = GenericPowerModel{StandardACPForm}

"default AC constructor"
ACDCPPowerModel(data::Dict{String,Any}; kwargs...) =
...
""
const APIACDCPPowerModel = GenericPowerModel{APIACPForm}

"default AC constructor"
APIACDCPPowerModel(data::Dict{String,Any}; kwargs...) =
...
""
function bounds_tighten_voltage(pm::APIACDCPPowerModel; epsilon = 0.001)
...
""
function upperbound_negative_active_generation(pm::APIACDCPPowerModel)
...
""
function constraint_kcl_shunt_scaled(pm::APIACDCPPowerModel, bus)
    i = bus["index"]
...
""
function get_solution(pm::APIACDCPPowerModel)
    # super fallback
...
""
function add_bus_demand_setpoint(sol, pm::APIACDCPPowerModel)
