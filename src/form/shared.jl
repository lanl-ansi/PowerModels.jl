...
function constraint_kcl_shunt(pm::GenericPowerModel{T}, n::Int, h::Int, i, bus_arcs, bus_arcs_dc, bus_gens, bus_loads, bus_shunts, pd, qd, gs, bs) where T <: AbstractWForms
    w    = var(pm, n, h, :w, i)
    pg   = var(pm, n, h, :pg)
    qg   = var(pm, n, h, :qg)
    p    = var(pm, n, h, :p)
...
```
"""
function constraint_kcl_shunt_ne(pm::GenericPowerModel{T}, n::Int, h::Int, i, bus_arcs, bus_arcs_dc, bus_arcs_ne, bus_gens, bus_loads, bus_shunts, pd, qd, gs, bs) where T <: AbstractWRForms
    w    = var(pm, n, h, :w, i)
    pg   = var(pm, n, h, :pg)
    qg   = var(pm, n, h, :qg)
    p    = var(pm, n, h, :p)
