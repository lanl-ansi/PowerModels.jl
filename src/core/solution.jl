...
function sol_component_value(aim::_IM.AbstractInfrastructureModel, n::Int, comp_name::Symbol, field_name::Symbol, comp_ids, variables)
...
function sol_component_value_edge(aim::_IM.AbstractInfrastructureModel, n::Int, comp_name::Symbol, field_name_fr::Symbol, field_name_to::Symbol, comp_ids_fr, comp_ids_to, variables)
