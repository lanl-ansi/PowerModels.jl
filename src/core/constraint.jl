...
function constraint_shunt_setpoint(pm::GenericPowerModel, n::Int, c::Int, i)
    fs = var(pm, n, c, :fs, i)
    JuMP.@constraint(pm.model, fs == 1.0)
end
