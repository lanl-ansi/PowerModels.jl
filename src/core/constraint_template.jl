...
function constraint_thermal_limit_from_on_off(pm::AbstractPowerModel, i::Int; nw::Int=nw_id_default)
    ...
    if !haskey(branch, "rate_a")
        @_error("constraint_thermal_limit_from_on_off requires a rate_a value on all branches, calc_thermal_limits! can be used to generate reasonable values")
    end
...
function constraint_thermal_limit_to_on_off(pm::AbstractPowerModel, i::Int; nw::Int=nw_id_default)
    ...
    if !haskey(branch, "rate_a")
        @_error("constraint_thermal_limit_to_on_off requires a rate_a value on all branches, calc_thermal_limits! can be used to generate reasonable values")
    end
...
function constraint_ne_thermal_limit_from(pm::AbstractPowerModel, i::Int; nw::Int=nw_id_default)
    ...
    if !haskey(branch, "rate_a")
        @_error("constraint_thermal_limit_from_ne requires a rate_a value on all branches, calc_thermal_limits! can be used to generate reasonable values")
    end
...
function constraint_ne_thermal_limit_to(pm::AbstractPowerModel, i::Int; nw::Int=nw_id_default)
    ...
    if !haskey(branch, "rate_a")
        @_error("constraint_thermal_limit_to_ne requires a rate_a value on all branches, calc_thermal_limits! can be used to generate reasonable values")
    end
...
function constraint_storage_state(pm::AbstractPowerModel, i::Int; nw::Int=nw_id_default)
    ...
    if haskey(ref(pm, nw), :time_elapsed)
        ...
        @_warn("network data should specify time_elapsed, using 1.0 as a default")
        time_elapsed = 1.0
    end
...
function constraint_storage_state(pm::AbstractPowerModel, i::Int, nw_1::Int, nw_2::Int)
    ...
    if haskey(ref(pm, nw_2), :time_elapsed)
        ...
        @_warn("network $(nw_2) should specify time_elapsed, using 1.0 as a default")
        time_elapsed = 1.0
    end
