...
@testset "test ac opf" begin
    @testset "3-bus case" begin
        result = run_ac_opf("../test/data/case3.json", ipopt_solver)
...
@testset "test dc opf" begin
    @testset "3-bus case" begin
        result = run_dc_opf("../test/data/case3.json", ipopt_solver)
    ...
    #@testset "24-bus rts case" begin
    #    result = run_opf("../test/data/case24.json", DCPPowerModel, ipopt_solver)
...
@testset "test soc opf" begin
    @testset "3-bus case" begin
        result = run_opf("../test/data/case3.json", SOCWRPowerModel, ipopt_solver)

        @test result["status"] == :LocalOptimal
        @test isapprox(result["objective"], 5735.9; atol = 1e0)
    end
    @testset "24-bus rts case" begin
        result = run_opf("../test/data/case24.json", SOCWRPowerModel, ipopt_solver)
...
@testset "test qc opf" begin
    @testset "3-bus case" begin
        result = run_opf("../test/data/case3.json", QCWRPowerModel, ipopt_solver)

        @test result["status"] == :LocalOptimal
        @test isapprox(result["objective"], 5742.0; atol = 1e0)
    end
    @testset "24-bus rts case" begin
        result = run_opf("../test/data/case24.json", QCWRPowerModel, ipopt_solver)
...
@testset "test sdp opf" begin
    @testset "3-bus case" begin
        result = run_opf("../test/data/case3.json", SDPWRMPowerModel, scs_solver)
    ...
    #@testset "24-bus rts case" begin
    #    result = run_opf("../test/data/case24.json", SDPWRMPowerModel, scs_solver)
