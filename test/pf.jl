@testset "test ac polar pf" begin
    ...
    @testset "5-bus multiple slack gens case" begin
        result = solve_pf("../test/data/matpower/case5_ext.m", ACPPowerModel, nlp_solver)
    ...
    @testset "5-bus case with hvdc line" begin
        result = solve_ac_pf("../test/data/matpower/case5_dc.m", nlp_solver)
    ...
    @testset "6-bus case" begin
        result = solve_pf("../test/data/matpower/case6.m", ACPPowerModel, nlp_solver)
...
@testset "test ac rect pf" begin
    @testset "5-bus asymmetric case" begin
        result = solve_pf("../test/data/matpower/case5_asym.m", ACRPowerModel, nlp_solver)
    ...
    @testset "5-bus case with hvdc line" begin
        result = solve_pf("../test/data/matpower/case5_dc.m", ACRPowerModel, nlp_solver)
...
@testset "test ac tan pf" begin
    ...
    # @testset "5-bus asymmetric case" begin
    #     result = solve_pf("../test/data/matpower/case5_asym.m", ACTPowerModel, nlp_solver)
...
@testset "test iv pf" begin
    @testset "3-bus case" begin
        result = solve_pf_iv("../test/data/matpower/case3.m", IVRPowerModel, nlp_solver, solution_processors=[sol_data_model!])
    ...
    @testset "5-bus case with hvdc line" begin
        result = solve_pf_iv("../test/data/matpower/case5_dc.m", IVRPowerModel, nlp_solver, solution_processors=[sol_data_model!])
...
@testset "test dc pf" begin
    @testset "3-bus case" begin
        result = solve_dc_pf("../test/data/matpower/case3.m", nlp_solver)
    ...
    @testset "5-bus asymmetric case" begin
        result = solve_dc_pf("../test/data/matpower/case5_asym.m", nlp_solver)

        @test result["termination_status"] == LOCALLY_SOLVED
        @test isapprox(result["objective"], 0; atol = 1e-2)
    end
    @testset "5-bus multiple slack gens case" begin
        result = solve_dc_pf("../test/data/matpower/case5_ext.m", nlp_solver)
    ...
    @testset "6-bus case" begin
        result = solve_dc_pf("../test/data/matpower/case6.m", nlp_solver)
    ...
    @testset "24-bus rts case" begin
        result = solve_pf("../test/data/matpower/case24.m", DCPPowerModel, nlp_solver)
...
@testset "test matpower dc pf" begin
    @testset "5-bus case with matpower DCMP model" begin
        result = solve_pf("../test/data/matpower/case5.m", DCMPPowerModel, nlp_solver)
...
@testset "test soc pf" begin
    ...
    # @testset "3-bus case" begin
    #     result = solve_pf("../test/data/matpower/case3.m", SOCWRPowerModel, nlp_solver, solution_processors=[sol_data_model!])
    ...
    # @testset "5-bus asymmetric case" begin
    #     result = solve_pf("../test/data/matpower/case5_asym.m", SOCWRPowerModel, nlp_solver)

    #     @test result["termination_status"] == LOCALLY_SOLVED
    #     @test isapprox(result["objective"], 0; atol = 1e-2)
    # end
    @testset "6-bus case" begin
        result = solve_pf("../test/data/matpower/case6.m", SOCWRPowerModel, nlp_solver, solution_processors=[sol_data_model!])
    ...
    @testset "24-bus rts case" begin
        result = solve_pf("../test/data/matpower/case24.m", SOCWRPowerModel, nlp_solver)
...
@testset "test soc distflow pf_bf" begin
    ...
    @testset "6-bus case" begin
        result = solve_pf_bf("../test/data/matpower/case6.m", SOCBFPowerModel, nlp_solver, solution_processors=[sol_data_model!])
    ...
    @testset "24-bus rts case" begin
        result = solve_pf_bf("../test/data/matpower/case24.m", SOCBFPowerModel, nlp_solver)
...
@testset "test linear distflow pf_bf" begin
    ...
    @testset "5-bus asymmetric case" begin
        result = solve_pf_bf("../test/data/matpower/case5_asym.m", BFAPowerModel, nlp_solver)

        @test result["termination_status"] == LOCALLY_SOLVED
        @test isapprox(result["objective"], 0; atol = 1e-2)
    end
    @testset "5-bus case with hvdc line" begin
        result = solve_pf_bf("../test/data/matpower/case5_dc.m", BFAPowerModel, nlp_solver)

        @test result["termination_status"] == LOCALLY_SOLVED
        @test isapprox(result["objective"], 0; atol = 1e-2)
    end
    @testset "6-bus case" begin
        result = solve_pf_bf("../test/data/matpower/case6.m", BFAPowerModel, nlp_solver, solution_processors=[sol_data_model!])
    ...
    @testset "24-bus rts case" begin
        ...
        result = solve_pf_bf(data, BFAPowerModel, nlp_solver)
...
@testset "test sdp pf" begin
    ...
    @testset "5-bus asymmetric case" begin
        result = solve_pf("../test/data/matpower/case5_asym.m", SDPWRMPowerModel, sdp_solver)

        @test result["termination_status"] == OPTIMAL
        @test isapprox(result["objective"], 0; atol = 1e-2)
    end
    @testset "6-bus case" begin
        result = solve_pf("../test/data/matpower/case6.m", SDPWRMPowerModel, sdp_solver, solution_processors=[sol_data_model!])
    ...
    @testset "24-bus rts case" begin
        result = solve_pf("../test/data/matpower/case24.m", SDPWRMPowerModel, sdp_solver)
