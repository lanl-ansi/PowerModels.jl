...
@testset "test ac pf" begin
    @testset "3-bus case" begin
        result = run_pf("../test/data/case3.json", ACPPowerModel, IpoptSolver(tol=1e-6, print_level=0))
    ...
    @testset "24-bus rts case" begin
        result = run_pf("../test/data/case24.json", ACPPowerModel, IpoptSolver(tol=1e-6, print_level=0))
...
@testset "test dc pf" begin
    @testset "3-bus case" begin
        result = run_pf("../test/data/case3.json", DCPPowerModel, IpoptSolver(tol=1e-6, print_level=0))
    ...
    @testset "24-bus rts case" begin
        result = run_pf("../test/data/case24.json", DCPPowerModel, IpoptSolver(tol=1e-6, print_level=0))
...
@testset "test soc pf" begin
    @testset "3-bus case" begin
        result = run_pf("../test/data/case3.json", SOCWRPowerModel, IpoptSolver(tol=1e-6, print_level=0))
    ...
    @testset "24-bus rts case" begin
        result = run_pf("../test/data/case24.json", SOCWRPowerModel, IpoptSolver(tol=1e-6, print_level=0))
