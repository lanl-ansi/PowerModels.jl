...
@testset "test ptdf-based dc opf" begin
    @testset "5-bus case, LP solver" begin
        ...
        result_va = PowerModels.solve_opf(data, DCPPowerModel, milp_solver)
        result_pg = PowerModels.solve_opf_ptdf(data, DCPPowerModel, milp_solver)
    ...
    @testset "5-bus gap case" begin
        ...
        result_va = PowerModels.solve_opf(data, DCPPowerModel, nlp_solver)
        result_pg = PowerModels.solve_opf_ptdf(data, DCPPowerModel, nlp_solver)
